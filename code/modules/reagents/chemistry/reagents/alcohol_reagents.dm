...
/datum/reagent/consumable/ethanol/eggnog
	...
	name = "Moony's curse"
	id = "moony_curse"
	description = "Unidentifiable mixture. Smells of badminium."
	color = "#664300"
	boozepwr = 1000 // Die.
	taste_description = "Why."
	glass_icon_state = "glass_brown2"
	glass_name = "Moony's curse; but in a glass"
	glass_desc = "Uhhhhh"

/datum/reagent/consumable/ethanol/moony_curse/on_mob_life(mob/living/M)
	if (!M.slurring)
		M.slurring = 1
	switch(current_cycle)
		if(1 to 30)
